...
def run_test_sum_of_digits():
    ...
    expected = 20
    answer = sum_of_digits(5528)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    expected = 15
    answer = sum_of_digits(9231)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 6
    answer = sum_of_digits(30003)
